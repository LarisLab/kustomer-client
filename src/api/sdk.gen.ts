...
import type { GetAuditLogsData, GetAuditLogsResponse, CreateAttachmentData, CreateAttachmentResponse, GetAttachmentsByIdData, GetAttachmentsByIdResponse, UpsertAttachmentData, UpsertAttachmentResponse, GetAttachmentByMessageAndAttachmentIdData, GetAttachmentByMessageAndAttachmentIdResponse, GetBrandsData, GetBrandsResponse, CreateBrandData, CreateBrandResponse, GetDefaultBrandData, GetDefaultBrandResponse, GetBrandByIdData, GetBrandByIdResponse, PatchBrandData, PatchBrandResponse, GetAllSchedulesData, GetAllSchedulesResponse, CreateScheduleData, CreateScheduleResponse, GetDefaultScheduleData, GetDefaultScheduleResponse, DeleteScheduleByIdData, DeleteScheduleByIdResponse, GetScheduleByIdData, GetScheduleByIdResponse, UpdateScheduleByIdData, UpdateScheduleByIdResponse, GetCompaniesData, GetCompaniesResponse, CreateCompanyData, CreateCompanyResponse, GetCompanyByIdData, GetCompanyByIdResponse, UpdateCompanyAttributesData, UpdateCompanyAttributesResponse, FindCompanyKObjectsData, FindCompanyKObjectsResponse, BulkCreateCompaniesData, BulkCreateCompaniesResponse, BulkBatchUpdateCompaniesData, BulkBatchUpdateCompaniesResponse, GetConversationsData, GetConversationsResponse, CreateConversationData, CreateConversationResponse, DeleteConversationData, GetConversationData, GetConversationResponse, GetConversationError, UpdateConversationAttributesData, UpdateConversationAttributesResponse, UpdateConversationData, UpdateConversationResponse, GetConversationByExternalIdData, GetConversationByExternalIdResponse, GetConversationAttachmentsData, GetConversationAttachmentsResponse, GetConversationEventsData, GetConversationEventsResponse, BulkCreateConversationsData, BulkCreateConversationsResponse, BulkBatchUpdateConversationsData, BulkBatchUpdateConversationsResponse, GetMessagesByConversationData, GetMessagesByConversationResponse, CreateMessagefromConversationData, CreateMessagefromConversationResponse, RemoveTagsfromConversationData, RemoveTagsfromConversationResponse, AppendTagsToConversationData, AppendTagsToConversationResponse, GetAllForwardsByConversationData, GetAllForwardsByConversationResponse, CreateaForwardByConversationData, CreateaForwardByConversationResponse, GetConversationTimesByConversationIdData, GetConversationTimesByConversationIdResponse, GetConversationTimeByIdsData, GetConversationTimeByIdsResponse, GetNotesbyConversationData, GetNotesbyConversationResponse, CreateaNoteWithinConversationData, CreateaNoteWithinConversationResponse, BulkDeleteCustomersData, BulkDeleteCustomersResponse, BulkCreateCustomersData, BulkCreateCustomersResponse, BulkBatchUpdateCustomersData, BulkBatchUpdateCustomersResponse, GetConversationsByCustomerData, GetConversationsByCustomerResponse, CreateConversationForCustomerData, CreateConversationForCustomerResponse, GetAllDraftsByCustomerData, GetAllDraftsByCustomerResponse, CreateDraftByCustomerData, CreateDraftByCustomerResponse, GetaCustomerEventData, GetaCustomerEventResponse, GetAllEventsbyCustomerForSessionData, GetAllEventsbyCustomerForSessionResponse, GetAllCustomerEventsData, GetAllCustomerEventsResponse, GetCustomerSessionsData, GetCustomerSessionsResponse, FindCustomerKObjectsData, FindCustomerKObjectsResponse, CreateCustomerKObjectData, CreateCustomerKObjectResponse, CreateCustomerMergeData, CreateCustomerMergeResponse, GetCustomerMergeData, GetCustomerMergeResponse, GetCustomerMergesByCustomerData, GetCustomerMergesByCustomerResponse, GetMessagesByCustomerData, GetMessagesByCustomerResponse, CreateMessageByCustomerData, CreateMessageByCustomerResponse, GetNotesByCustomerData, GetNotesByCustomerResponse, DeleteUnmaskingWindowByCustomerData, CreateUnmaskingWindowByCustomerData, GetCustomersData, GetCustomersResponse, CreateCustomerData, CreateCustomerResponse, DeleteCustomerData, GetCustomerByIdData, GetCustomerByIdResponse, UpdateCustomerAttributesData, UpdateCustomerAttributesResponse, UpdateCustomerData, UpdateCustomerResponse, GetCustomerByEmailData, GetCustomerByEmailResponse, GetCustomerByExternalIdData, GetCustomerByExternalIdResponse, GetCustomerByPhoneData, GetCustomerByPhoneResponse, GetCustomAttributeMetadataData, GetCustomAttributeMetadataResponse, UpdateCustomAttributeMetadataData, UpdateCustomAttributeMetadataResponse, GetDraftAttachmentsData, GetDraftAttachmentsResponse, CreateDraftAttachmentData, CreateDraftAttachmentResponse, DeleteDraftAttachmentData, GetDraftAttachmentData, GetDraftAttachmentResponse, GetaDraftForwardByIdData, GetaDraftForwardByIdResponse, UpdateDraftForwardData, UpdateDraftForwardResponse, GetForwardAttachmentsData, GetForwardAttachmentsResponse, CreateForwardAttachmentData, CreateForwardAttachmentResponse, DeleteForwardAttachmentData, GetForwardAttachmentData, GetForwardAttachmentResponse, GetOutboundAccountsData, GetOutboundAccountsResponse, DeleteDraftData, UpdateDraftData, UpdateDraftResponse, BulkDeleteKObjectsData, BulkDeleteKObjectsResponse, BulkCreateKObjectsData, BulkCreateKObjectsResponse, BulkBatchUpdateKObjectsData, BulkBatchUpdateKObjectsResponse, GetKObjectsData, GetKObjectsResponse, CreateKObjectData, CreateKObjectResponse, DeleteKObjectData, GetKObjectData, GetKObjectResponse, UpdateKObjectData, UpdateKObjectResponse, GetKlassesData, GetKlassesResponse, CreateaKlassData, CreateaKlassResponse, DeleteKlassData, GetKlassData, GetKlassResponse, UpdateKlassData, UpdateKlassResponse, CreateMediaData, CreateMediaResponse, GetMediabyIdData, GetMediabyIdResponse, UpdateMediaData, UpdateMediaResponse, BulkCreateMessagesData, BulkCreateMessagesResponse, BulkBatchUpdateMessagesData, BulkBatchUpdateMessagesResponse, RedactMessageData, RedactMessageResponse, GetMessagesData, GetMessagesResponse, GetMessagesError, CreateMessageData, CreateMessageResponse, GetMessageData, GetMessageResponse, UpdateMessageAttributesData, UpdateMessageAttributesResponse, UpdateMessageData, UpdateMessageResponse, GetMessagebyExternalIdData, GetMessagebyExternalIdResponse, BulkCreateNotesData, BulkCreateNotesResponse, BulkBatchUpdateNotesData, BulkBatchUpdateNotesResponse, GetNotesForOrgData, GetNotesForOrgResponse, CreateNoteData, CreateNoteResponse, DeleteNoteByIdData, GetNotebyIdData, GetNotebyIdResponse, PatchNoteByIdData, PatchNoteByIdResponse, UpdateNoteByIdData, UpdateNoteByIdResponse, CreateTrackingEventData, CreateTrackingIdentityData, CreateTrackingIdentityResponse, CreateTrackingIdentityEventData, CreateTrackingIdentityEventResponse, CustomerSearchData, CustomerSearchResponse, CustomerArchiveSearchData, CustomerArchiveSearchResponse, GetSatisfactionData, GetSatisfactionResponse, GetSlaByIdData, GetSlaByIdResponse, GetSpamSendersData, GetSpamSendersResponse, UpsertSpamSenderData, UpsertSpamSenderResponse, DeleteSpamSenderData, GetKlassesByNameAndExternalIdData, GetKlassesByNameAndExternalIdResponse } from './types.gen';
 ...
 */
export const getAttachmentsById = <ThrowOnError extends boolean = true>(options: Options<GetAttachmentsByIdData, ThrowOnError>) => {
    return options.client.get<GetAttachmentsByIdResponse, unknown, ThrowOnError>({
        url: '/attachments/{id}',
        ...options
    });
};
 ...
 */
export const upsertAttachment = <ThrowOnError extends boolean = true>(options: Options<UpsertAttachmentData, ThrowOnError>) => {
 ...
 * |org.user.attachment.read|org.permission.attachment.read|
 */
export const getAttachmentByMessageAndAttachmentId = <ThrowOnError extends boolean = true>(options: Options<GetAttachmentByMessageAndAttachmentIdData, ThrowOnError>) => {
    return options.client.get<GetAttachmentByMessageAndAttachmentIdResponse, unknown, ThrowOnError>({
 ...
 * |org.user.brand.read|
 */
export const getBrands = <ThrowOnError extends boolean = true>(options: Options<GetBrandsData, ThrowOnError>) => {
 ...
 */
export const createBrand = <ThrowOnError extends boolean = true>(options: Options<CreateBrandData, ThrowOnError>) => {
 ...
 * |org.user.brand.read|
 */
export const getDefaultBrand = <ThrowOnError extends boolean = true>(options: Options<GetDefaultBrandData, ThrowOnError>) => {
 ...
 * |org.user.brand.read|
 */
export const getBrandById = <ThrowOnError extends boolean = true>(options: Options<GetBrandByIdData, ThrowOnError>) => {
 ...
 */
export const patchBrand = <ThrowOnError extends boolean = true>(options: Options<PatchBrandData, ThrowOnError>) => {
 ...
 */
export const getAllSchedules = <ThrowOnError extends boolean = true>(options: Options<GetAllSchedulesData, ThrowOnError>) => {
 ...
 */
export const createSchedule = <ThrowOnError extends boolean = true>(options: Options<CreateScheduleData, ThrowOnError>) => {
 ...
 * |org.admin.schedule.read||
 */
export const getDefaultSchedule = <ThrowOnError extends boolean = true>(options: Options<GetDefaultScheduleData, ThrowOnError>) => {
    return options.client.get<GetDefaultScheduleResponse, unknown, ThrowOnError>({
 ...
 */
export const deleteScheduleById = <ThrowOnError extends boolean = true>(options: Options<DeleteScheduleByIdData, ThrowOnError>) => {
    return options.client.delete<DeleteScheduleByIdResponse, unknown, ThrowOnError>({
        url: '/schedules/{id}',
        ...options
    });
};
 ...
 * |org.admin.schedule.read||
 */
export const getScheduleById = <ThrowOnError extends boolean = true>(options: Options<GetScheduleByIdData, ThrowOnError>) => {
 ...
 */
export const updateScheduleById = <ThrowOnError extends boolean = true>(options: Options<UpdateScheduleByIdData, ThrowOnError>) => {
    return options.client.put<UpdateScheduleByIdResponse, unknown, ThrowOnError>({
        url: '/schedules/{id}',
        ...options,
        headers: {
            'Content-Type': 'application/json',
 ...
 */
export const getCompanies = <ThrowOnError extends boolean = true>(options: Options<GetCompaniesData, ThrowOnError>) => {
 ...
 */
export const createCompany = <ThrowOnError extends boolean = true>(options: Options<CreateCompanyData, ThrowOnError>) => {
 ...
 * |org.user.company.read|org.permission.company.read|
 */
export const getCompanyById = <ThrowOnError extends boolean = true>(options: Options<GetCompanyByIdData, ThrowOnError>) => {
 ...
 * * `Url` *string* or *null*, format: *uri*
 */
export const updateCompanyAttributes = <ThrowOnError extends boolean = true>(options: Options<UpdateCompanyAttributesData, ThrowOnError>) => {
    return options.client.put<UpdateCompanyAttributesResponse, unknown, ThrowOnError>({
        url: '/companies/{id}',
        ...options,
        headers: {
            'Content-Type': 'application/json',
 ...
 * |org.user.company.read|org.permission.company.read|
 */
export const findCompanyKObjects = <ThrowOnError extends boolean = true>(options: Options<FindCompanyKObjectsData, ThrowOnError>) => {
    return options.client.get<FindCompanyKObjectsResponse, unknown, ThrowOnError>({
 ...
 * * `Url` *string* or *null*, format: *uri*
 */
export const bulkCreateCompanies = <ThrowOnError extends boolean = true>(options: Options<BulkCreateCompaniesData, ThrowOnError>) => {
    return options.client.post<BulkCreateCompaniesResponse, unknown, ThrowOnError>({
        url: '/companies/bulk',
        ...options,
        headers: {
            'Content-Type': 'application/json',
 ...
 * * `Url` *string* or *null*, format: *uri*
 */
export const bulkBatchUpdateCompanies = <ThrowOnError extends boolean = true>(options: Options<BulkBatchUpdateCompaniesData, ThrowOnError>) => {
    return options.client.put<BulkBatchUpdateCompaniesResponse, unknown, ThrowOnError>({
        url: '/companies/bulk',
        ...options,
        headers: {
            'Content-Type': 'application/json',
 ...
 */
export const getConversations = <ThrowOnError extends boolean = true>(options: Options<GetConversationsData, ThrowOnError>) => {
...
export const createConversation = <ThrowOnError extends boolean = true>(options: Options<CreateConversationData, ThrowOnError>) => {
    return options.client.post<CreateConversationResponse, unknown, ThrowOnError>({
        url: '/conversations',
        ...options,
        headers: {
            'Content-Type': 'application/json',
 ...
 */
export const deleteConversation = <ThrowOnError extends boolean = true>(options: Options<DeleteConversationData, ThrowOnError>) => {
...
export const getConversation = <ThrowOnError extends boolean = true>(options: Options<GetConversationData, ThrowOnError>) => {
    return options.client.get<GetConversationResponse, GetConversationError, ThrowOnError>({
        url: '/conversations/{id}',
        ...options
    });
};
 ...
 * * `Url` *string* or *null*, format: *uri*
 */
export const updateConversationAttributes = <ThrowOnError extends boolean = true>(options: Options<UpdateConversationAttributesData, ThrowOnError>) => {
    return options.client.patch<UpdateConversationAttributesResponse, unknown, ThrowOnError>({
        url: '/conversations/{id}',
        ...options,
        headers: {
...
export const updateConversation = <ThrowOnError extends boolean = true>(options: Options<UpdateConversationData, ThrowOnError>) => {
    return options.client.put<UpdateConversationResponse, unknown, ThrowOnError>({
        url: '/conversations/{id}',
        ...options,
        headers: {
            'Content-Type': 'application/json',
 ...
 * |org.user.conversation.read|org.permission.conversation.read|
 */
export const getConversationByExternalId = <ThrowOnError extends boolean = true>(options: Options<GetConversationByExternalIdData, ThrowOnError>) => {
    return options.client.get<GetConversationByExternalIdResponse, unknown, ThrowOnError>({
 ...
 * |org.user.attachment.read|org.permission.attachment.read|
 */
export const getConversationAttachments = <ThrowOnError extends boolean = true>(options: Options<GetConversationAttachmentsData, ThrowOnError>) => {
    return options.client.get<GetConversationAttachmentsResponse, unknown, ThrowOnError>({
 ...
 */
export const getConversationEvents = <ThrowOnError extends boolean = true>(options: Options<GetConversationEventsData, ThrowOnError>) => {
    return options.client.get<GetConversationEventsResponse, unknown, ThrowOnError>({
 ...
 * |org.user.conversation.write|org.permission.conversation.create|
 */
export const bulkCreateConversations = <ThrowOnError extends boolean = true>(options: Options<BulkCreateConversationsData, ThrowOnError>) => {
    return options.client.post<BulkCreateConversationsResponse, unknown, ThrowOnError>({
 ...
 * |org.user.conversation.write|org.permission.conversation.update|
 */
export const bulkBatchUpdateConversations = <ThrowOnError extends boolean = true>(options: Options<BulkBatchUpdateConversationsData, ThrowOnError>) => {
    return options.client.put<BulkBatchUpdateConversationsResponse, unknown, ThrowOnError>({
        url: '/conversations/bulk',
        ...options,
        headers: {
            'Content-Type': 'application/json',
 ...
 */
export const getMessagesByConversation = <ThrowOnError extends boolean = true>(options: Options<GetMessagesByConversationData, ThrowOnError>) => {
    return options.client.get<GetMessagesByConversationResponse, unknown, ThrowOnError>({
 ...
 * A `429 Too Many Requests` response will be returned if the rate limit has been reached for a customer.
 */
export const createMessagefromConversation = <ThrowOnError extends boolean = true>(options: Options<CreateMessagefromConversationData, ThrowOnError>) => {
    return options.client.post<CreateMessagefromConversationResponse, unknown, ThrowOnError>({
        url: '/conversations/{id}/messages',
        ...options,
        headers: {
            'Content-Type': 'application/json',
 ...
 */
export const removeTagsfromConversation = <ThrowOnError extends boolean = true>(options: Options<RemoveTagsfromConversationData, ThrowOnError>) => {
    return options.client.delete<RemoveTagsfromConversationResponse, unknown, ThrowOnError>({
 ...
 * > This endpoint is subject to Object Rate Limiting, which limits how many updates a single User can make to a single Conversation. See [Rate limiting](https://developer.kustomer.com/kustomer-api-docs/reference/rate-limiting) for more information.
 */
export const appendTagsToConversation = <ThrowOnError extends boolean = true>(options: Options<AppendTagsToConversationData, ThrowOnError>) => {
    return options.client.post<AppendTagsToConversationResponse, unknown, ThrowOnError>({
        url: '/conversations/{id}/tags',
        ...options,
        headers: {
            'Content-Type': 'application/json',
 ...
 */
export const getAllForwardsByConversation = <ThrowOnError extends boolean = true>(options: Options<GetAllForwardsByConversationData, ThrowOnError>) => {
    return options.client.get<GetAllForwardsByConversationResponse, unknown, ThrowOnError>({
 ...
 *
 */
export const createaForwardByConversation = <ThrowOnError extends boolean = true>(options: Options<CreateaForwardByConversationData, ThrowOnError>) => {
    return options.client.post<CreateaForwardByConversationResponse, unknown, ThrowOnError>({
        url: '/conversations/{id}/forwards',
        ...options,
        headers: {
            'Content-Type': 'application/json',
 ...
 * |org.user.conversation.read|org.permission.conversation.read|
 */
export const getConversationTimesByConversationId = <ThrowOnError extends boolean = true>(options: Options<GetConversationTimesByConversationIdData, ThrowOnError>) => {
    return options.client.get<GetConversationTimesByConversationIdResponse, unknown, ThrowOnError>({
 ...
 * |org.user.conversation.read|org.permission.conversation.read|
 */
export const getConversationTimeByIds = <ThrowOnError extends boolean = true>(options: Options<GetConversationTimeByIdsData, ThrowOnError>) => {
    return options.client.get<GetConversationTimeByIdsResponse, unknown, ThrowOnError>({
 ...
 */
export const getNotesbyConversation = <ThrowOnError extends boolean = true>(options: Options<GetNotesbyConversationData, ThrowOnError>) => {
    return options.client.get<GetNotesbyConversationResponse, unknown, ThrowOnError>({
 ...
 */
export const createaNoteWithinConversation = <ThrowOnError extends boolean = true>(options: Options<CreateaNoteWithinConversationData, ThrowOnError>) => {
    return options.client.post<CreateaNoteWithinConversationResponse, unknown, ThrowOnError>({
        url: '/conversations/{id}/notes',
        ...options,
        headers: {
            'Content-Type': 'application/json',
 ...
 */
export const bulkDeleteCustomers = <ThrowOnError extends boolean = true>(options: Options<BulkDeleteCustomersData, ThrowOnError>) => {
    return options.client.delete<BulkDeleteCustomersResponse, unknown, ThrowOnError>({
        url: '/customers/bulk',
        ...options
    });
};
 ...
 */
export const bulkCreateCustomers = <ThrowOnError extends boolean = true>(options: Options<BulkCreateCustomersData, ThrowOnError>) => {
    return options.client.post<BulkCreateCustomersResponse, unknown, ThrowOnError>({
        url: '/customers/bulk',
        ...options,
        headers: {
            'Content-Type': 'application/json',
 ...
 */
export const bulkBatchUpdateCustomers = <ThrowOnError extends boolean = true>(options: Options<BulkBatchUpdateCustomersData, ThrowOnError>) => {
    return options.client.put<BulkBatchUpdateCustomersResponse, unknown, ThrowOnError>({
        url: '/customers/bulk',
        ...options,
        headers: {
            'Content-Type': 'application/json',
 ...
 * |org.user.conversation.read|org.permission.conversation.read|
 */
export const getConversationsByCustomer = <ThrowOnError extends boolean = true>(options: Options<GetConversationsByCustomerData, ThrowOnError>) => {
    return options.client.get<GetConversationsByCustomerResponse, unknown, ThrowOnError>({
 ...
 * * `Url` *string* or *null*, format: *uri*
 */
export const createConversationForCustomer = <ThrowOnError extends boolean = true>(options: Options<CreateConversationForCustomerData, ThrowOnError>) => {
    return options.client.post<CreateConversationForCustomerResponse, unknown, ThrowOnError>({
        url: '/customers/{id}/conversations',
        ...options,
        headers: {
            'Content-Type': 'application/json',
 ...
 * |org.user.draft.read|org.permission.draft.read|
 */
export const getAllDraftsByCustomer = <ThrowOnError extends boolean = true>(options: Options<GetAllDraftsByCustomerData, ThrowOnError>) => {
    return options.client.get<GetAllDraftsByCustomerResponse, unknown, ThrowOnError>({
 ...
 * A `429 Too Many Requests` response will be returned if the rate limit has been reached for a customer.
 */
export const createDraftByCustomer = <ThrowOnError extends boolean = true>(options: Options<CreateDraftByCustomerData, ThrowOnError>) => {
    return options.client.post<CreateDraftByCustomerResponse, unknown, ThrowOnError>({
        url: '/customers/{id}/drafts',
        ...options,
        headers: {
            'Content-Type': 'application/json',
 ...
 * |org.user.event.read|org.permission.event.read|
 */
export const getaCustomerEvent = <ThrowOnError extends boolean = true>(options: Options<GetaCustomerEventData, ThrowOnError>) => {
 ...
 * |org.user.event.read|org.permission.event.read|
 */
export const getAllEventsbyCustomerForSession = <ThrowOnError extends boolean = true>(options: Options<GetAllEventsbyCustomerForSessionData, ThrowOnError>) => {
    return options.client.get<GetAllEventsbyCustomerForSessionResponse, unknown, ThrowOnError>({
 ...
 * |org.user.event.read|org.permission.event.read|
 */
export const getAllCustomerEvents = <ThrowOnError extends boolean = true>(options: Options<GetAllCustomerEventsData, ThrowOnError>) => {
    return options.client.get<GetAllCustomerEventsResponse, unknown, ThrowOnError>({
 ...
 * |org.user.event.read|org.permission.event.read|
 */
export const getCustomerSessions = <ThrowOnError extends boolean = true>(options: Options<GetCustomerSessionsData, ThrowOnError>) => {
    return options.client.get<GetCustomerSessionsResponse, unknown, ThrowOnError>({
 ...
 */
export const findCustomerKObjects = <ThrowOnError extends boolean = true>(options: Options<FindCustomerKObjectsData, ThrowOnError>) => {
    return options.client.get<FindCustomerKObjectsResponse, unknown, ThrowOnError>({
 ...
 */
export const createCustomerKObject = <ThrowOnError extends boolean = true>(options: Options<CreateCustomerKObjectData, ThrowOnError>) => {
    return options.client.post<CreateCustomerKObjectResponse, unknown, ThrowOnError>({
        url: '/customers/{id}/klasses/{name}',
        ...options,
        headers: {
            'Content-Type': 'application/json',
 ...
 * - gender
 */
export const createCustomerMerge = <ThrowOnError extends boolean = true>(options: Options<CreateCustomerMergeData, ThrowOnError>) => {
    return options.client.post<CreateCustomerMergeResponse, unknown, ThrowOnError>({
 ...
 */
export const getCustomerMerge = <ThrowOnError extends boolean = true>(options: Options<GetCustomerMergeData, ThrowOnError>) => {
 ...
 * |org.admin.customer.merge.read|
 */
export const getCustomerMergesByCustomer = <ThrowOnError extends boolean = true>(options: Options<GetCustomerMergesByCustomerData, ThrowOnError>) => {
    return options.client.get<GetCustomerMergesByCustomerResponse, unknown, ThrowOnError>({
 ...
 * |org.user.message.read|org.permission.message.read|
 */
export const getMessagesByCustomer = <ThrowOnError extends boolean = true>(options: Options<GetMessagesByCustomerData, ThrowOnError>) => {
    return options.client.get<GetMessagesByCustomerResponse, unknown, ThrowOnError>({
 ...
 * A `429 Too Many Requests` response will be returned if the rate limit has been reached for a customer.
 */
export const createMessageByCustomer = <ThrowOnError extends boolean = true>(options: Options<CreateMessageByCustomerData, ThrowOnError>) => {
    return options.client.post<CreateMessageByCustomerResponse, unknown, ThrowOnError>({
        url: '/customers/{id}/messages',
        ...options,
        headers: {
            'Content-Type': 'application/json',
 ...
 * |org.user.note.read|org.permission.note.read|
 */
export const getNotesByCustomer = <ThrowOnError extends boolean = true>(options: Options<GetNotesByCustomerData, ThrowOnError>) => {
    return options.client.get<GetNotesByCustomerResponse, unknown, ThrowOnError>({
 ...
 */
export const deleteUnmaskingWindowByCustomer = <ThrowOnError extends boolean = true>(options: Options<DeleteUnmaskingWindowByCustomerData, ThrowOnError>) => {
    return options.client.delete<unknown, unknown, ThrowOnError>({
        bodySerializer: null,
 ...
 */
export const createUnmaskingWindowByCustomer = <ThrowOnError extends boolean = true>(options: Options<CreateUnmaskingWindowByCustomerData, ThrowOnError>) => {
 ...
 * |org.user.customer.read|org.permission.customer.read|
 */
export const getCustomers = <ThrowOnError extends boolean = true>(options: Options<GetCustomersData, ThrowOnError>) => {
 ...
 * * `Url` *string* or *null*, format: *uri*
 */
export const createCustomer = <ThrowOnError extends boolean = true>(options: Options<CreateCustomerData, ThrowOnError>) => {
 ...
 * |org.user.customer.delete|org.permission.customer.delete|
 */
export const deleteCustomer = <ThrowOnError extends boolean = true>(options: Options<DeleteCustomerData, ThrowOnError>) => {
    return options.client.delete<unknown, unknown, ThrowOnError>({
        url: '/customers/{id}',
        ...options
    });
 ...
 * |org.user.customer.read|org.permission.customer.read|
 */
export const getCustomerById = <ThrowOnError extends boolean = true>(options: Options<GetCustomerByIdData, ThrowOnError>) => {
 ...
 * * `Url` *string* or *null*, format: *uri*
 */
export const updateCustomerAttributes = <ThrowOnError extends boolean = true>(options: Options<UpdateCustomerAttributesData, ThrowOnError>) => {
    return options.client.patch<UpdateCustomerAttributesResponse, unknown, ThrowOnError>({
        url: '/customers/{id}',
        ...options,
        headers: {
            'Content-Type': 'application/json',
 ...
 * * `Url` *string* or *null*, format: *uri*
 */
export const updateCustomer = <ThrowOnError extends boolean = true>(options: Options<UpdateCustomerData, ThrowOnError>) => {
 ...
 * |org.user.customer.read|org.permission.customer.read|
 */
export const getCustomerByEmail = <ThrowOnError extends boolean = true>(options: Options<GetCustomerByEmailData, ThrowOnError>) => {
    return options.client.get<GetCustomerByEmailResponse, unknown, ThrowOnError>({
 ...
 * |org.user.customer.read|org.permission.customer.read|
 */
export const getCustomerByExternalId = <ThrowOnError extends boolean = true>(options: Options<GetCustomerByExternalIdData, ThrowOnError>) => {
    return options.client.get<GetCustomerByExternalIdResponse, unknown, ThrowOnError>({
 ...
 * |org.user.customer.read|org.permission.customer.read|
 */
export const getCustomerByPhone = <ThrowOnError extends boolean = true>(options: Options<GetCustomerByPhoneData, ThrowOnError>) => {
    return options.client.get<GetCustomerByPhoneResponse, unknown, ThrowOnError>({
 ...
 *
 */
export const getCustomAttributeMetadata = <ThrowOnError extends boolean = true>(options: Options<GetCustomAttributeMetadataData, ThrowOnError>) => {
    return options.client.get<GetCustomAttributeMetadataResponse, unknown, ThrowOnError>({
 ...
 *
 */
export const updateCustomAttributeMetadata = <ThrowOnError extends boolean = true>(options: Options<UpdateCustomAttributeMetadataData, ThrowOnError>) => {
    return options.client.put<UpdateCustomAttributeMetadataResponse, unknown, ThrowOnError>({
        url: '/metadata/{resource}',
        ...options,
        headers: {
            'Content-Type': 'application/json',
 ...
 * |org.user.attachment.read|org.permission.attachment.read|
 */
export const getDraftAttachments = <ThrowOnError extends boolean = true>(options: Options<GetDraftAttachmentsData, ThrowOnError>) => {
    return options.client.get<GetDraftAttachmentsResponse, unknown, ThrowOnError>({
 ...
 * ```
 */
export const createDraftAttachment = <ThrowOnError extends boolean = true>(options: Options<CreateDraftAttachmentData, ThrowOnError>) => {
    return options.client.post<CreateDraftAttachmentResponse, unknown, ThrowOnError>({
        url: '/drafts/{id}/attachments',
        ...options,
        headers: {
            'Content-Type': 'application/json',
 ...
 */
export const deleteDraftAttachment = <ThrowOnError extends boolean = true>(options: Options<DeleteDraftAttachmentData, ThrowOnError>) => {
    return options.client.delete<unknown, unknown, ThrowOnError>({
 ...
 */
export const getDraftAttachment = <ThrowOnError extends boolean = true>(options: Options<GetDraftAttachmentData, ThrowOnError>) => {
    return options.client.get<GetDraftAttachmentResponse, unknown, ThrowOnError>({
        url: '/drafts/{id}/attachments/{attachmentId}',
        ...options
    });
};
 ...
 * |org.user.draft.read|org.permission.draft.read|
 */
export const getaDraftForwardById = <ThrowOnError extends boolean = true>(options: Options<GetaDraftForwardByIdData, ThrowOnError>) => {
    return options.client.get<GetaDraftForwardByIdResponse, unknown, ThrowOnError>({
        url: '/forwards/{id}',
        ...options
    });
};
 ...
 */
export const updateDraftForward = <ThrowOnError extends boolean = true>(options: Options<UpdateDraftForwardData, ThrowOnError>) => {
    return options.client.put<UpdateDraftForwardResponse, unknown, ThrowOnError>({
        url: '/forwards/{id}',
        ...options,
        headers: {
            'Content-Type': 'application/json',
 ...
 */
export const getForwardAttachments = <ThrowOnError extends boolean = true>(options: Options<GetForwardAttachmentsData, ThrowOnError>) => {
    return options.client.get<GetForwardAttachmentsResponse, unknown, ThrowOnError>({
 ...
 * ```
 */
export const createForwardAttachment = <ThrowOnError extends boolean = true>(options: Options<CreateForwardAttachmentData, ThrowOnError>) => {
    return options.client.post<CreateForwardAttachmentResponse, unknown, ThrowOnError>({
        url: '/forwards/{id}/attachments',
        ...options,
        headers: {
            'Content-Type': 'application/json',
 ...
 */
export const deleteForwardAttachment = <ThrowOnError extends boolean = true>(options: Options<DeleteForwardAttachmentData, ThrowOnError>) => {
    return options.client.delete<unknown, unknown, ThrowOnError>({
 ...
 * When you request the resource, the response will include a **related** URL in the **links** section. You can use this URL to download the attachment file.  This URL is a Pre-Signed URL from S3 and provides access for a limited duration to download a file.
 */
export const getForwardAttachment = <ThrowOnError extends boolean = true>(options: Options<GetForwardAttachmentData, ThrowOnError>) => {
    return options.client.get<GetForwardAttachmentResponse, unknown, ThrowOnError>({
        url: '/forwards/{id}/attachments/{attachmentId}',
        ...options
    });
};
 ...
 */
export const getOutboundAccounts = <ThrowOnError extends boolean = true>(options: Options<GetOutboundAccountsData, ThrowOnError>) => {
    return options.client.get<GetOutboundAccountsResponse, unknown, ThrowOnError>({
 ...
 * Deletes a draft.
 */
export const deleteDraft = <ThrowOnError extends boolean = true>(options: Options<DeleteDraftData, ThrowOnError>) => {
    return options.client.delete<unknown, unknown, ThrowOnError>({
        url: '/drafts/{id}',
        ...options
    });
 ...
 */
export const updateDraft = <ThrowOnError extends boolean = true>(options: Options<UpdateDraftData, ThrowOnError>) => {
 ...
 */
export const bulkDeleteKObjects = <ThrowOnError extends boolean = true>(options: Options<BulkDeleteKObjectsData, ThrowOnError>) => {
    return options.client.delete<BulkDeleteKObjectsResponse, unknown, ThrowOnError>({
 ...
 * ||org.permission.kobject.kobject_*.create|
 */
export const bulkCreateKObjects = <ThrowOnError extends boolean = true>(options: Options<BulkCreateKObjectsData, ThrowOnError>) => {
    return options.client.post<BulkCreateKObjectsResponse, unknown, ThrowOnError>({
        url: '/klasses/{name}/bulk',
        ...options,
        headers: {
            'Content-Type': 'application/json',
 ...
 */
export const bulkBatchUpdateKObjects = <ThrowOnError extends boolean = true>(options: Options<BulkBatchUpdateKObjectsData, ThrowOnError>) => {
    return options.client.put<BulkBatchUpdateKObjectsResponse, unknown, ThrowOnError>({
        url: '/klasses/{name}/bulk',
        ...options,
        headers: {
            'Content-Type': 'application/json',
 ...
 */
export const getKObjects = <ThrowOnError extends boolean = true>(options: Options<GetKObjectsData, ThrowOnError>) => {
 ...
 * * A `429 Too Many Requests` response will be returned if the rate limit has been reached for a customer.
 */
export const createKObject = <ThrowOnError extends boolean = true>(options: Options<CreateKObjectData, ThrowOnError>) => {
 ...
 * ||org.permission.kobject.kobject_*.delete|
 */
export const deleteKObject = <ThrowOnError extends boolean = true>(options: Options<DeleteKObjectData, ThrowOnError>) => {
    return options.client.delete<unknown, unknown, ThrowOnError>({
        url: '/klasses/{name}/{id}',
        ...options
    });
 ...
 */
export const getKObject = <ThrowOnError extends boolean = true>(options: Options<GetKObjectData, ThrowOnError>) => {
 ...
 * * `Url` *string* or *null*, format: *uri*
 */
export const updateKObject = <ThrowOnError extends boolean = true>(options: Options<UpdateKObjectData, ThrowOnError>) => {
 ...
 * |org.admin.klass.read||
 */
export const getKlasses = <ThrowOnError extends boolean = true>(options: Options<GetKlassesData, ThrowOnError>) => {
 ...
 */
export const createaKlass = <ThrowOnError extends boolean = true>(options: Options<CreateaKlassData, ThrowOnError>) => {
 ...
 */
export const deleteKlass = <ThrowOnError extends boolean = true>(options: Options<DeleteKlassData, ThrowOnError>) => {
    return options.client.delete<unknown, unknown, ThrowOnError>({
        url: '/klasses/{id}',
        ...options
    });
 ...
 * |org.admin.klass.read||
 */
export const getKlass = <ThrowOnError extends boolean = true>(options: Options<GetKlassData, ThrowOnError>) => {
 ...
 */
export const updateKlass = <ThrowOnError extends boolean = true>(options: Options<UpdateKlassData, ThrowOnError>) => {
 ...
 * - .wsl
 */
export const createMedia = <ThrowOnError extends boolean = true>(options: Options<CreateMediaData, ThrowOnError>) => {
 ...
 * |org.admin.kb.read||
 */
export const getMediabyId = <ThrowOnError extends boolean = true>(options: Options<GetMediabyIdData, ThrowOnError>) => {
 ...
 */
export const updateMedia = <ThrowOnError extends boolean = true>(options: Options<UpdateMediaData, ThrowOnError>) => {
 ...
 * |org.user.message.write|org.permission.message.create|
 */
export const bulkCreateMessages = <ThrowOnError extends boolean = true>(options: Options<BulkCreateMessagesData, ThrowOnError>) => {
    return options.client.post<BulkCreateMessagesResponse, unknown, ThrowOnError>({
        url: '/messages/bulk',
        ...options,
        headers: {
            'Content-Type': 'application/json',
 ...
 */
export const bulkBatchUpdateMessages = <ThrowOnError extends boolean = true>(options: Options<BulkBatchUpdateMessagesData, ThrowOnError>) => {
    return options.client.put<BulkBatchUpdateMessagesResponse, unknown, ThrowOnError>({
        url: '/messages/bulk',
        ...options,
        headers: {
            'Content-Type': 'application/json',
 ...
 */
export const redactMessage = <ThrowOnError extends boolean = true>(options: Options<RedactMessageData, ThrowOnError>) => {
 ...
 * |org.user.message.read|org.permission.message.read|
 */
export const getMessages = <ThrowOnError extends boolean = true>(options: Options<GetMessagesData, ThrowOnError>) => {
    return options.client.get<GetMessagesResponse, GetMessagesError, ThrowOnError>({
        url: '/messages',
        ...options
    });
};
 ...
 * |org.user.message.read|org.permission.message.read|
 */
export const getMessage = <ThrowOnError extends boolean = true>(options: Options<GetMessageData, ThrowOnError>) => {
 ...
 * * `Url` *string* or *null*, format: *uri*
 */
export const updateMessageAttributes = <ThrowOnError extends boolean = true>(options: Options<UpdateMessageAttributesData, ThrowOnError>) => {
    return options.client.patch<UpdateMessageAttributesResponse, unknown, ThrowOnError>({
        url: '/messages/{id}',
        ...options,
        headers: {
            'Content-Type': 'application/json',
 ...
 * * `Url` *string* or *null*, format: *uri*
 */
export const updateMessage = <ThrowOnError extends boolean = true>(options: Options<UpdateMessageData, ThrowOnError>) => {
 ...
 */
export const getMessagebyExternalId = <ThrowOnError extends boolean = true>(options: Options<GetMessagebyExternalIdData, ThrowOnError>) => {
    return options.client.get<GetMessagebyExternalIdResponse, unknown, ThrowOnError>({
 ...
 * |org.user.note.write|org.permission.note.create|
 */
export const bulkCreateNotes = <ThrowOnError extends boolean = true>(options: Options<BulkCreateNotesData, ThrowOnError>) => {
 ...
 */
export const bulkBatchUpdateNotes = <ThrowOnError extends boolean = true>(options: Options<BulkBatchUpdateNotesData, ThrowOnError>) => {
    return options.client.put<BulkBatchUpdateNotesResponse, unknown, ThrowOnError>({
        url: '/notes/bulk',
        ...options,
        headers: {
            'Content-Type': 'application/json',
 ...
 * |org.user.note.read|org.permission.note.read|
 */
export const getNotesForOrg = <ThrowOnError extends boolean = true>(options: Options<GetNotesForOrgData, ThrowOnError>) => {
 ...
 * Notes are subject to a rate limit. A single client can create up to 120 notes per minute per customer.
 */
export const createNote = <ThrowOnError extends boolean = true>(options: Options<CreateNoteData, ThrowOnError>) => {
 ...
 */
export const deleteNoteById = <ThrowOnError extends boolean = true>(options: Options<DeleteNoteByIdData, ThrowOnError>) => {
    return options.client.delete<unknown, unknown, ThrowOnError>({
        url: '/notes/{id}',
        ...options
    });
 ...
 * |org.user.note.read|org.permission.note.read|
 */
export const getNotebyId = <ThrowOnError extends boolean = true>(options: Options<GetNotebyIdData, ThrowOnError>) => {
 ...
 * > The `org.admin` role is required for setting `createdAt`, `createdBy`, `modifiedAt`, and `modifiedBy`.  Otherwise, these attributes are automatically set by the token.
 */
export const patchNoteById = <ThrowOnError extends boolean = true>(options: Options<PatchNoteByIdData, ThrowOnError>) => {
 ...
 * > The `org.admin` role is required for setting `createdAt`, `createdBy`, `modifiedAt`, and `modifiedBy`.  Otherwise, these attributes are automatically set by the token.
 */
export const updateNoteById = <ThrowOnError extends boolean = true>(options: Options<UpdateNoteByIdData, ThrowOnError>) => {
 ...
 */
export const createTrackingEvent = <ThrowOnError extends boolean = true>(options: Options<CreateTrackingEventData, ThrowOnError>) => {
    return options.client.post<unknown, unknown, ThrowOnError>({
        url: '/tracking/event',
        ...options,
        headers: {
 ...
 * The following role is required for this endpoint: org.tracking
 */
export const createTrackingIdentity = <ThrowOnError extends boolean = true>(options: Options<CreateTrackingIdentityData, ThrowOnError>) => {
    return options.client.post<CreateTrackingIdentityResponse, unknown, ThrowOnError>({
 ...
 * The following role is required for this endpoint: org.tracking
 */
export const createTrackingIdentityEvent = <ThrowOnError extends boolean = true>(options: Options<CreateTrackingIdentityEventData, ThrowOnError>) => {
    return options.client.post<CreateTrackingIdentityEventResponse, unknown, ThrowOnError>({
 ...
 *
 */
export const customerSearch = <ThrowOnError extends boolean = true>(options: Options<CustomerSearchData, ThrowOnError>) => {
 ...
 *
 */
export const customerArchiveSearch = <ThrowOnError extends boolean = true>(options: Options<CustomerArchiveSearchData, ThrowOnError>) => {
    return options.client.post<CustomerArchiveSearchResponse, unknown, ThrowOnError>({
 ...
 */
export const getSatisfaction = <ThrowOnError extends boolean = true>(options: Options<GetSatisfactionData, ThrowOnError>) => {
 ...
 */
export const getSlaById = <ThrowOnError extends boolean = true>(options: Options<GetSlaByIdData, ThrowOnError>) => {
 ...
 */
export const getSpamSenders = <ThrowOnError extends boolean = true>(options: Options<GetSpamSendersData, ThrowOnError>) => {
 ...
 */
export const upsertSpamSender = <ThrowOnError extends boolean = true>(options: Options<UpsertSpamSenderData, ThrowOnError>) => {
 ...
 */
export const deleteSpamSender = <ThrowOnError extends boolean = true>(options: Options<DeleteSpamSenderData, ThrowOnError>) => {
    return options.client.delete<unknown, unknown, ThrowOnError>({
        url: '/spam/senders/{id}',
        ...options
    });
 ...
 */
export const getKlassesByNameAndExternalId = <ThrowOnError extends boolean = true>(options: Options<GetKlassesByNameAndExternalIdData, ThrowOnError>) => {
    return options.client.get<GetKlassesByNameAndExternalIdResponse, unknown, ThrowOnError>({
